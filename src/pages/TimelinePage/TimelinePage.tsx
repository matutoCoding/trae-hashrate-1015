...
import { Clock, Play, Pause, SkipBack, Zap, AlertTriangle, Download, Plus, Trash2, Settings, RefreshCw, Eye } from 'lucide-react';
...
import type { SmokeWarning, LaunchCommand, TimelineSegment } from '@/types';
      ...
      <AnimatePresence>
        {showSaveModal && (
          ...
          >
            ...
            >
              <h3 className="font-display text-xl font-bold text-white mb-6">保存发射脚本</h3>
              <div className="space-y-4">
                <div>
